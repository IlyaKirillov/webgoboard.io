...
function LoadMenu()
{
    ...
    AddMenuItem(oMenu, "http://www.goban.org/index", "Kogo's joseki");
    AddMenuItem(oMenu, "http://www.goban.org/19", "Board 19x19");
    AddMenuItem(oMenu, "http://www.goban.org/13", "Board 13x13");
    AddMenuItem(oMenu, "http://www.goban.org/9", "Board 9x9");
    AddMenuItem(oMenu, "http://www.goban.org/introduction", "Introduction to Go");
    AddMenuItem(oMenu, "http://www.goban.org/problems", "Problems");
